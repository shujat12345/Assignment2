...
Security
Insights
Batch04_to_35/Assignments/Assignment2/Assignment2_NumpyBasicsToAdvance.py /
@EnggQasim
EnggQasim Pandas Basics class1
Latest commit 07eedb3 7 days ago
 History
 1 contributor
349 lines (266 sloc)  8.88 KB
...
def function2():
    ...
    x = np.arange(10,37,1,dtype=np.float64).reshape((3,3,3))     #wrtie your code here
...
def function3():
    ...
    x = x = a[(a%7 == 0) & (a%5 == 0)] #wrtie your code here
    return x
    """
    Expected Output:
...
def function6():
    ...
    arr = np.zeros(20) #wrtie your code here
    arr[4] = 10
    arr[7] = 20
...
def function13():
    ...
    ans = ans = arr[(arr > 5) & (arr < 10)] #write your code here 
...
def function17():
    ...
    return np.where((arr % 3 == 0) & (arr % 5 == 0), "Yes", np.where(arr % 3 != 0, "No", np.where(arr % 5 != 0, "No", arr)))          # Write Your Code HERE
